...
protocol Fetchable
{
    ...
    static func objects(for predicate: NSPredicate?, sortedBy: AttributeName?,
                        ascending: Bool, fetchLimit: Int) throws -> [FetchableType]
    static func objects(sortedBy sortDescriptors: [NSSortDescriptor],predicate: NSPredicate?,
                        fetchLimit: Int) throws -> [FetchableType]
    static func objects(sortedBy sortCriteria: (AttributeName, Bool)..., predicate: NSPredicate?,
                        fetchLimit: Int) throws -> [FetchableType]
    
    static func object() throws -> FetchableType?
    static func object(for predicate: NSPredicate?, sortedBy: AttributeName?,
                       ascending: Bool) throws -> FetchableType?
    static func object(sortedBy sortDescriptors: [NSSortDescriptor],
                       predicate: NSPredicate?) throws -> FetchableType?
